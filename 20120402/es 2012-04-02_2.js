...
var pillars = SIMPLEX_GRID([
  ...
  [1.5, 3, 3]               //z - quote 3 piani - la prima coordinata è alta 1.5 (rialzo dal suolo)
  ]);
...
var sidegrid2 = S([0])([2])(grid);
var sidegridL = S([0])([-1])(sidegrid2);
var sidegridR = T([0])([3*14.7])(sidegrid2);

var sidegrids = COLOR([0.2,0.2,0.2])(STRUCT([sidegridL, sidegridR]));

var backgrids = T([1])([14.7])(S([1])([-1])(sidegrids));

var sideGridSet = STRUCT([sidegrids, backgrids]);

var roofsquare = SIMPLEX_GRID([[-7*2.4, 4*2.4, -7*2.4],[-2, 10,-2],[-7.5,1]]);


var building = STRUCT ([steelFrames, floors, cantilever1, cantilever2, frames, backFrames, sideGridSet, roofsquare]);
