...
var domainBody3 = DOMAIN([[0,1],[0,1],[0,1]])([10,10,10]);
//COMPONENTS DOMAIN
...
//JACKPLATE
var jackBorder = COLOR(black)(DISK(0.4)([32]));
var jackBolt = COLOR(chrome)(CYL_SURFACE([0.3,0.2])([6]));
var jack = STRUCT ([jackBorder,jackBolt]);
...
//BODY ELEMENTS MODEL
var bodyElements = STRUCT([bodyMain_colored, neck_colored, headMain_colored]);
//DRAW(bodyElements);
